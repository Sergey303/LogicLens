...
internal static class PostgresCompletionTestData
{
    public static async Task<CompletionFixture> SeedLeasedJobAsync(NpgsqlDataSource dataSource)
    {
    ...
    public static ProcessingCompletionPayload Completion(Guid revisionId)
    {
...
internal sealed record CompletionFixture(Guid RevisionId, ProcessingJobSnapshot Job);
