...
export type DocumentFragmentFieldKind = "text" | "number" | "date" | "boolean" | "lookup";

export type DocumentFragmentFieldValue = string | number | boolean | null | undefined;

export interface DocumentFragmentFieldLookupOption {
  readonly label: string;
  readonly value: string;
}

export interface DocumentFragmentFieldProps {
  readonly id: string;
  readonly label: string;
  readonly kind: DocumentFragmentFieldKind;
  readonly value: DocumentFragmentFieldValue;
  readonly onChange: (value: DocumentFragmentFieldValue) => void;
  readonly required?: boolean;
  readonly disabled?: boolean;
  readonly error?: string | null;
  readonly helperText?: string | null;
  readonly lookupOptions?: readonly DocumentFragmentFieldLookupOption[];
  readonly onLookupFilter?: (query: string) => void;
}

export function DocumentFragmentField(props: DocumentFragmentFieldProps) {
...
function renderInput(props: DocumentFragmentFieldProps, describedBy: string | undefined) {
...
function toCalendarValue(value: DocumentFragmentFieldValue) {
  if (typeof value !== "string" || value.length === 0) {
    return null;
  }
