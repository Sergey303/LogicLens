...
export type StaffPositionFieldKind = "text" | "number" | "date" | "boolean" | "lookup";

export type StaffPositionFieldValue = string | number | boolean | null | undefined;

export interface StaffPositionFieldLookupOption {
  readonly label: string;
  readonly value: string;
}

export interface StaffPositionFieldProps {
  readonly id: string;
  readonly label: string;
  readonly kind: StaffPositionFieldKind;
  readonly value: StaffPositionFieldValue;
  readonly onChange: (value: StaffPositionFieldValue) => void;
  readonly required?: boolean;
  readonly disabled?: boolean;
  readonly error?: string | null;
  readonly helperText?: string | null;
  readonly lookupOptions?: readonly StaffPositionFieldLookupOption[];
  readonly onLookupFilter?: (query: string) => void;
}

export function StaffPositionField(props: StaffPositionFieldProps) {
...
function renderInput(props: StaffPositionFieldProps, describedBy: string | undefined) {
...
function toCalendarValue(value: StaffPositionFieldValue) {
  if (typeof value !== "string" || value.length === 0) {
    return null;
  }
