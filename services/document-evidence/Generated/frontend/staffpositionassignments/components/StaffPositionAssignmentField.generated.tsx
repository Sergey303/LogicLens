...
export type StaffPositionAssignmentFieldKind = "text" | "number" | "date" | "boolean" | "lookup";

export type StaffPositionAssignmentFieldValue = string | number | boolean | null | undefined;

export interface StaffPositionAssignmentFieldLookupOption {
  readonly label: string;
  readonly value: string;
}

export interface StaffPositionAssignmentFieldProps {
  readonly id: string;
  readonly label: string;
  readonly kind: StaffPositionAssignmentFieldKind;
  readonly value: StaffPositionAssignmentFieldValue;
  readonly onChange: (value: StaffPositionAssignmentFieldValue) => void;
  readonly required?: boolean;
  readonly disabled?: boolean;
  readonly error?: string | null;
  readonly helperText?: string | null;
  readonly lookupOptions?: readonly StaffPositionAssignmentFieldLookupOption[];
  readonly onLookupFilter?: (query: string) => void;
}

export function StaffPositionAssignmentField(props: StaffPositionAssignmentFieldProps) {
...
function renderInput(props: StaffPositionAssignmentFieldProps, describedBy: string | undefined) {
...
function toCalendarValue(value: StaffPositionAssignmentFieldValue) {
  if (typeof value !== "string" || value.length === 0) {
    return null;
  }
