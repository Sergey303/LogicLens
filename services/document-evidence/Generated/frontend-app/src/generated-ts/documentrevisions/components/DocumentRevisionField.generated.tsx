...
export type DocumentRevisionFieldKind = "text" | "number" | "date" | "boolean" | "lookup";

export type DocumentRevisionFieldValue = string | number | boolean | null | undefined;

export interface DocumentRevisionFieldLookupOption {
  readonly label: string;
  readonly value: string;
}

export interface DocumentRevisionFieldProps {
  readonly id: string;
  readonly label: string;
  readonly kind: DocumentRevisionFieldKind;
  readonly value: DocumentRevisionFieldValue;
  readonly onChange: (value: DocumentRevisionFieldValue) => void;
  readonly required?: boolean;
  readonly disabled?: boolean;
  readonly error?: string | null;
  readonly helperText?: string | null;
  readonly lookupOptions?: readonly DocumentRevisionFieldLookupOption[];
  readonly onLookupFilter?: (query: string) => void;
}

export function DocumentRevisionField(props: DocumentRevisionFieldProps) {
...
function renderInput(props: DocumentRevisionFieldProps, describedBy: string | undefined) {
...
function toCalendarValue(value: DocumentRevisionFieldValue) {
  if (typeof value !== "string" || value.length === 0) {
    return null;
  }
