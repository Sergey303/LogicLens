...
export type DocumentFieldKind = "text" | "number" | "date" | "boolean" | "lookup";

export type DocumentFieldValue = string | number | boolean | null | undefined;

export interface DocumentFieldLookupOption {
...
export interface DocumentFieldProps {
  ...
  readonly value: DocumentFieldValue;
  readonly onChange: (value: DocumentFieldValue) => void;
  readonly required?: boolean;
  readonly disabled?: boolean;
  readonly error?: string | null;
  readonly helperText?: string | null;
  readonly lookupOptions?: readonly DocumentFieldLookupOption[];
  readonly onLookupFilter?: (query: string) => void;
}

export function DocumentField(props: DocumentFieldProps) {
...
function renderInput(props: DocumentFieldProps, describedBy: string | undefined) {
...
function toCalendarValue(value: DocumentFieldValue) {
  if (typeof value !== "string" || value.length === 0) {
    return null;
  }
