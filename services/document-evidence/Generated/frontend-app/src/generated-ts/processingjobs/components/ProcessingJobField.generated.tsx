...
export type ProcessingJobFieldKind = "text" | "number" | "date" | "boolean" | "lookup";

export type ProcessingJobFieldValue = string | number | boolean | null | undefined;

export interface ProcessingJobFieldLookupOption {
  readonly label: string;
  readonly value: string;
}

export interface ProcessingJobFieldProps {
  readonly id: string;
  readonly label: string;
  readonly kind: ProcessingJobFieldKind;
  readonly value: ProcessingJobFieldValue;
  readonly onChange: (value: ProcessingJobFieldValue) => void;
  readonly required?: boolean;
  readonly disabled?: boolean;
  readonly error?: string | null;
  readonly helperText?: string | null;
  readonly lookupOptions?: readonly ProcessingJobFieldLookupOption[];
  readonly onLookupFilter?: (query: string) => void;
}

export function ProcessingJobField(props: ProcessingJobFieldProps) {
...
function renderInput(props: ProcessingJobFieldProps, describedBy: string | undefined) {
...
function toCalendarValue(value: ProcessingJobFieldValue) {
  if (typeof value !== "string" || value.length === 0) {
    return null;
  }
