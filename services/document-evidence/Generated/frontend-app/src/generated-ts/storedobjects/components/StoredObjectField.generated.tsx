...
export type StoredObjectFieldKind = "text" | "number" | "date" | "boolean" | "lookup";

export type StoredObjectFieldValue = string | number | boolean | null | undefined;

export interface StoredObjectFieldLookupOption {
  readonly label: string;
  readonly value: string;
}

export interface StoredObjectFieldProps {
  readonly id: string;
  readonly label: string;
  readonly kind: StoredObjectFieldKind;
  readonly value: StoredObjectFieldValue;
  readonly onChange: (value: StoredObjectFieldValue) => void;
  readonly required?: boolean;
  readonly disabled?: boolean;
  readonly error?: string | null;
  readonly helperText?: string | null;
  readonly lookupOptions?: readonly StoredObjectFieldLookupOption[];
  readonly onLookupFilter?: (query: string) => void;
}

export function StoredObjectField(props: StoredObjectFieldProps) {
...
function renderInput(props: StoredObjectFieldProps, describedBy: string | undefined) {
...
function toCalendarValue(value: StoredObjectFieldValue) {
  if (typeof value !== "string" || value.length === 0) {
    return null;
  }
